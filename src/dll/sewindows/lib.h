...
typedef	struct _FILE_PATH_TABLE
{
	WCHAR dos_name[3];
	WCHAR nt_name[40];
}FILE_PATH_TABLE, *PFILE_PATH_TABLE;

typedef  struct _REG_PATH_TABLE
{
	WCHAR	destPath[MAX_PATH];
	ULONG	dstlen;
	WCHAR	srcPath[MAX_PATH];
	ULONG	srclen;
} REG_PATH_TABLE, *PREG_PATH_TABLE;
...
typedef NTSTATUS (NTAPI *fn_RtlConvertSidToUnicodeString)(
